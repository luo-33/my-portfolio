...
export declare const computeSequencePropsSubscriptionFromContent: ({ fileContents, absolutePath, line, preferredNodePath, componentIdentity, keys, assetKeys, effects, videoConfigValues, }: {
    fileContents: string;
    absolutePath: string;
    line: number;
